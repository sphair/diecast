...
public:
	...
	const std::list<ServerGameObjectPtr> &get_children();
...
// Signals:
public:
	clan::Signal_v0 sig_initialized;
	clan::Signal_v2<const ServerGameObjectPtr &, bool /*moved*/> sig_child_added;
	clan::Signal_v2<const ServerGameObjectPtr &, bool /*moved*/> sig_child_removed;
